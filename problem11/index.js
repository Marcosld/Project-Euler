...
const getProduct = (n, i, j, iOp, jOp) => n > 0
  ? numbers[i][j] * getProduct(n - 1, i + iOp, j + jOp, iOp, jOp)
  : 1

const getBiggestAdjacentProduct = (n, i, j) => Math.max(
  getProduct(n, i, j, 1, 0),
  getProduct(n, i, j, 1, 1),
  getProduct(n, i, j, 1, -1),
  getProduct(n, i, j, 0, 1),
  getProduct(n, i, j, 0, -1),
  getProduct(n, i, j, -1, 0),
  getProduct(n, i, j, -1, 1),
  getProduct(n, i, j, -1, -1),
...
const getBiggestProduct = (n, i = n, j = n) =>
  j < (numbers.length - n)
    ? Math.max(getBiggestAdjacentProduct(n, i, j), getBiggestProduct(n, i, j + 1))
    : i < (numbers[0].length - n)
      ? getBiggestProduct(n, i + 1, n)
      : 0
